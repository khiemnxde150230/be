...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=.;Initial Catalog=dbFourSeasonHotel;Integrated Security=True; TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Booking>(entity =>
        {
            entity.HasKey(e => e.BookingId).HasName("PK__Booking__73951AED76705B0C");
        ...
        {
            entity.HasKey(e => e.BookingDetailId).HasName("PK__BookingD__8136D45AA638EAAE");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A0B5C52E1F7");
        ...
        {
            entity.HasKey(e => e.RoleId).HasName("PK__Role__8AFACE1A09636B42");
        ...
        {
            entity.HasKey(e => e.RoomId).HasName("PK__Room__328639392545D878");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__RoomImg__3214EC07BA7AF18C");
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__User__1788CC4CC6E75911");
